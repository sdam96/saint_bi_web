  ...
  <div>
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 mt-1">
      ...
      <DashboardCard title="Ventas y Utilidad (Período Actual)">
        <li class="list-group-item d-flex justify-content-between"><span>Ventas de Contado:</span> <strong>{{ formatNumber(summary.currentPeriod.TotalNetSalesCash) }}</strong></li>
        <li class="list-group-item d-flex justify-content-between"><span>Ventas a Crédito:</span> <strong>{{ formatNumber(summary.currentPeriod.TotalNetSalesCredit) }}</strong></li>
      ...
      <DashboardCard title="Cuentas por Cobrar">
        ...
        <li class="list-group-item d-flex justify-content-between"><span>Clientes con Deuda:</span> <strong>{{ summary.currentPeriod.ActiveClientsWithDebt }}</strong></li>
      </DashboardCard>
